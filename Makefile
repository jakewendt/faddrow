...
ISDC_ENV		= /isdc_sw/osa_sw/osa_sw-5.1/WS/7
...
ISDCROOTDIR_TO_SKIP	= 
ISDCROOT_INC_DIR	= -I/isdc_sw/osa_sw/osa_sw-5.1/WS/7/root/include/root
ISDCROOT_LIB_DIR	= -L/isdc_sw/osa_sw/osa_sw-5.1/WS/7/root/lib
...
RANLIB			= ranlib
INSTALL			= /unsaved_data/wendt/workspace/faddrow/ac_stuff/isdc_install
...
DEFS			= -DPACKAGE_NAME=\"\" -DPACKAGE_TARNAME=\"\" -DPACKAGE_VERSION=\"\" -DPACKAGE_STRING=\"\" -DPACKAGE_BUGREPORT=\"\" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_UNISTD_H=1 -DSIZEOF_SHORT=2 -DSIZEOF_INT=4 -DSIZEOF_LONG=4 -DSIZEOF_LONG_LONG=8 -DSIZEOF_VOID_P=4 -DSTDC_HEADERS=1 -DHAVE_MALLOC_H=1 -DHAVE_PTHREAD_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRCHR=1 -DHAVE_MEMCPY=1 -DHAVE_GMTIME_R=1 -DHAVE_STRTOLL=1 -DHAVE_LLABS=1 -DWORDS_BIGENDIAN=1 -DHAVE_FLOCK_T=1 -DHAVE_READLINE_LIBS=1  -DHAVE_CERN_ROOT=1
LIBOBJS			= 
X_INCLUDES		= -I/usr/openwin/include
X_LIBRARIES		= -L/usr/openwin/lib
LAST_LIBS		= -lreadline -ltermcap -lm -lsocket -lnsl
POSIX4_LIB		= -lposix4
